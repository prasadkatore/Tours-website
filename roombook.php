        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a class="active-menu" href="roombook.php"><i class="fa fa-bar-chart-o"></i>  Booking</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                             Booking<small>	<?php echo  $curdate; ?> </small>
                        </h1>
                    </div>
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 ...
												 $package_price=0;
													if($troom=="Superior Room")
														...
														$fintot = $ttot + $mepr + $btot+$pk_price ;
															
															//echo "<script type='text/javascript'> alert('$count_date')</script>";
														$psql = "INSERT INTO `payment`(`id`, `title`, `fname`, `lname`,`package`, `troom`, `tbed`, `nroom`, `cin`, `cout`,`pk_price`, `ttot`,`meal`, `mepr`, `btot`,`fintot`,`noofdays`) VALUES ('$id','$title','$fname','$lname','$package','$troom','$bed','$nroom','$cin','$cout','$pk_price','$ttot','$meal','$mepr','$btot','$fintot','$days')";
